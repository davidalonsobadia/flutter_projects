...
class _LocationInputState extends State<LocationInput> {
  ...
  Future<void> _savePlace(double latitude, double longitude) async {
    final url = Uri.parse(
        'https://maps.googleapis.com/maps/api/geocode/json?latlng=$latitude,$longitude&key=AIzaSyDKL486Ozus9UHGE5z3KS7EKcT-G0q3orE');
    ...
    setState(() {
      _pickedLocation = PlaceLocation(
          latitute: latitude, longitude: longitude, address: address);
